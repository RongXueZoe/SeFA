...
class DiffusionUnetHybridImageMetaworldPolicy(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
        ...
        obs_feature_dim = obs_encoder.output_shape()[0]    ## 113
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor], action_embedding=None, object_embedding=None) -> Dict[str, torch.Tensor]:
        """
