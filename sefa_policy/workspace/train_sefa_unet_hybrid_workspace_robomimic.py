...
from sefa_policy.common.checkpoint_util_resume import TopKCheckpointManager
...
class TrainSeFAUnetHybridWorkspace(BaseWorkspace):
    ...
    def run(self):
        ...
        if cfg.mode == 'refine':
            ...
            rf2_path = f"data/robomimic/{cfg.task.env_name}/{cfg.sefa_name}.pkl"
            action_sequences, target_poses, sampled_video_paths = load_all_samples(f"data/robomimic/{cfg.task.env_name}")
            z0_cllt = {}
            z1_cllt = {}
            cond_cllt = {}
            ...
            with open(f"data/robomimic/{cfg.task.env_name}/{cfg.sefa_name}_refined.pkl", "wb") as f:
        ...
        if cfg.mode == 'gen_data':
            ...
            gen_data = {"z0_cllt": z0_cllt, "z1_cllt": z1_cllt, "cond_cllt": cond_cllt}
            with open(f"data/robomimic/{cfg.task.env_name}/{cfg.sefa_name}.pkl", "wb") as f:
                pickle.dump(gen_data, f)
            print(f"Generated RecFlow data saved to {f.name}")
            return
            ...
            for _ in range(cfg.training.num_epochs):
                ...
                with tqdm.tqdm(train_dataloader, desc=f"Training epoch {self.epoch}", 
                    ...
                    for batch_idx, batch in enumerate(tepoch):
                        ...
                        if train_sampling_batch is None:
                            train_sampling_batch = batch
                        if cfg.training.resume and cfg.training.only_eval:
                ...
                if (self.epoch % cfg.training.sample_every) == 0:
                    with torch.no_grad():
                        # sample trajectory from training set, and evaluate action difference
