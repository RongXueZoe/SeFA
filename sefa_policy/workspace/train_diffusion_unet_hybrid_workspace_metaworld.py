...
from sefa_policy.policy.diffusion_unet_hybrid_image_metaworld_policy import DiffusionUnetHybridImageMetaworldPolicy
...
class TrainDiffusionUnetHybridWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionUnetHybridImageMetaworldPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionUnetHybridImageMetaworldPolicy = None
